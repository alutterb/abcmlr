...
add <- function(shape, arg1, arg2, arg3) {
    ...
    } else if (shape == "dot" || shape == "rawdot" || shape == "curve" || shape == "landmark") {
...
set <- function(shape, attr, arg1, arg2, arg3) {
    if (shape == "window") {
        ...
        if (attr == "scale" || attr == "amount" || attr == "id") {
        ...
        else if (attr == "coordinate" || attr == "dcolor" || attr == "color") {
